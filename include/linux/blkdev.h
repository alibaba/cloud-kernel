...
typedef int (poll_q_fn) (struct request_queue *, blk_qc_t, bool spin);
...
#define QUEUE_FLAG_NOWAIT       30	/* device supports NOWAIT */
#define QUEUE_FLAG_ZONE_RESETALL	31	/* supports Zone Reset All */
...
static inline struct bio_vec req_bvec(struct request *rq)
{
	...
	return bvec_iter_bvec(rq->bio->bi_io_vec, rq->bio->bi_iter);
}
